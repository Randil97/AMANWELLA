...
<title>Reservation Validation</title>
    ...
    <link rel="stylesheet" href="vender/nouislider/nouislider.min.css">

  
    <!-- Theme Style -->
    <link rel="stylesheet" href="css/style.css">
    <link rel="stylesheet" href="css/veriregcss.css">
...
<body>
 ...
 <section class="section contact-section" id="next">
    ...
    <script src="vender/nouislider/nouislider.min.js"></script>
    <script src="vender/wnumb/wNumb.js"></script>
    <script src="vender/jquery-validation/dist/jquery.validate.min.js"></script>
    <script src="vender/jquery-validation/dist/additional-methods.min.js"></script>
