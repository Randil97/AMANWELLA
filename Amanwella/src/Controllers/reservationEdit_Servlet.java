	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else 
		{
			...
			{ 
				 ...
				 * out.println("var r = confirm(\"Press a button!\");");
				 * out.println("if (r == true) {"); reservationDao.Delete(id);
				 * out.println("</script>"); out.println("<script type=\"text/javascript\">");
				 * out.println("location='index.jsp'"); out.println("} else {");
				 * out.println("location='res_sevlet'"); out.println("</script>");
				 */
			...
			{
				/*
				 * Reservation r2 = reservationDao.GetReservationDetails(id);
				 * 
				 * if(r2.getStatus() == "Confirm") { PrintWriter writer = response.getWriter();
				 * writer.println(r2.getStatus()); } else { PrintWriter writer =
				 * response.getWriter(); writer.println(r2.getStatus()); }
				 */	  
				if(check_in != null && check_out != null) 
				{
				...
				/*.println("success");
				response.sendRedirect("resValidation.jsp");*/
